...
function MovieDetails({ selectedId,onCloseMovie,onAddWatched,watched }) {
  ...
  const {Title:title,Poster:poster,Released:released,Runtime:runtime,imdbRating,
  Plot:plot,Actors:actors,Director:director,Genre:genre, Year:year
  } = movie;
  ...
  useEffect(() => {
    if (userRating) {
      document.title = `You rated ${title} ${userRating} ⭐️`;
    }
    return () => {
